...
//Brand Components
let storebrand = require('./components/brands/Create.vue').default; //route path
let brand = require('./components/brands/Index.vue').default;
...
export const routes = [
    ...
    { path: '/store-brand', component:storebrand, name:'store-brand'},
