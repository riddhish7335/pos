<template>
    <!-- start base div -->
        <div>
            ...
            <div class="row mb-3">
                ...
                <div class="card h-100">
                    ...
                    <div class="row align-items-center">
                        <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">Today Sales Amount</div>
                ...
                <div class="card h-100">
                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="mt-2 mb-0 text-muted text-xs">
                            <span class="text-danger mr-2"><i class="fas fa-box"></i> 1.10%</span>
                            <span>Since yesterday</span>
                        </div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="col-lg-12 mb-4" v-if="products.length">
              <!-- Simple Tables -->
              <div class="card">
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="product in products" :key="product.id">
                        ...
                        <td><img :src="product.image" class="em_photo" width="50"></td>
...
import axios from 'axios';
    ...
    export default{
        ...
        methods:{
            getDashboardStats(){
                axios.get(globalURL+'api/today/dashboardstats')
                .then(response => {
                        this.todaysell = response.data.today_sell;
                        this.income = response.data.income;
                        this.due = response.data.todaydue;
                        this.expense = response.data.todayexpense;
                        this.total_products = response.data.totalproducts;
                        this.total_stock = response.data.totalstock;
            ...
            TodaySell(){
                axios.get(globalURL+'/api/today/sell/')
                 .then(({data}) => (this.todaysell = data))
                 .catch()
            },

             TodayIncome(){
                axios.get(globalURL+'/api/today/income/')
                 .then(({data}) => (this.income = data))
                 .catch()
            },
             TodayDue(){
                axios.get(globalURL+'/api/today/due/')
                 .then(({data}) => (this.due = data))
                 .catch()
            },
             TodayExpense(){
                axios.get(globalURL+'/api/today/expense/')
                 .then(({data}) => (this.expense = data))
                 .catch()
            },
             StockOut(){
                axios.get(globalURL+'/api/today/stockout/')
